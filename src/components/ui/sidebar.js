...
var SidebarTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(Button, __assign({ ref: ref, "data-sidebar": "trigger", variant: "ghost", size: "icon", className: cn("size-10 [&_svg]:size-6", className), onClick: function (event) {
...
var SidebarInput = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(Input, __assign({ ref: ref, "data-sidebar": "input", className: cn("h-10 w-full", className) }, props)));
});
