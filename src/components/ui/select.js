...
var SelectTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(SelectPrimitive.Trigger, __assign({ ref: ref, className: cn("flex h-10 w-full items-center justify-between rounded-md border border-primary bg-white px-3 py-2 text-sm  placeholder:text-neutral-500 focus:outline-none focus:ring-0 hover:border-2 focus:border-2 hover:shadow disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-primary dark:bg-background dark:ring-0 dark:placeholder:text-neutral-400 ", className) }, props),
        children,
...
var SelectContent = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(SelectPrimitive.Portal, null,
        React.createElement(SelectPrimitive.Content, __assign({ ref: ref, className: cn("relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-md border border-primary bg-white text-neutral-950 shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 dark:border-primary dark:bg-background dark:text-neutral-50", position === "popper" &&
...
var SelectItem = React.forwardRef(function (_a, ref) {
    var className = _a.className, children = _a.children, props = __rest(_a, ["className", "children"]);
    return (React.createElement(SelectPrimitive.Item, __assign({ ref: ref, className: cn("relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-secondary focus:text-neutral-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-secondary dark:focus:text-neutral-50", className) }, props),
...
var SelectSeparator = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(SelectPrimitive.Separator, __assign({ ref: ref, className: cn("-mx-1 my-1 h-px bg-neutral-100 dark:bg-neutral-800", className) }, props)));
});
