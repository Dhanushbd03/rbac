...
var SheetTitle = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(SheetPrimitive.Title, __assign({ ref: ref, className: cn("text-lg font-semibold text-neutral-950 dark:text-neutral-50", className) }, props)));
});
SheetTitle.displayName = SheetPrimitive.Title.displayName;
var SheetDescription = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(SheetPrimitive.Description, __assign({ ref: ref, className: cn("text-sm text-neutral-500 dark:text-neutral-400", className) }, props)));
});
